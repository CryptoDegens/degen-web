...
async function main() {
    ...
    const stakingTokenAddr = DEGEN_DAI_DEGEN_UNI_TOKEN_ADDR;
    const stakingTokenTicker = "UNIV2";
    const pairTokenAddr = DAI_TOKEN_ADDR;
    const pairTokenTicker = "DAI";
    const rewardPoolAddr = DEGEN_DAI_DEGEN_REWARD_ADDR;
    const rewardTokenAddr = DEGEN_TOKEN_ADDR;
    const rewardTokenTicker = "DEGEN";
    const prices = await lookUpPrices(["dai", "spaghetti"]);
    const pairTokenPrice = prices["dai"].usd;
