...
async function main() {
    ...
    const stakingTokenAddr = DEGEN_USDT_DEGEN_UNI_TOKEN_ADDR;
    const stakingTokenTicker = "UNIV2";
    const pairTokenAddr = USDT_TOKEN_ADDR;
    const pairTokenTicker = "USDT";
    const rewardPoolAddr = DEGEN_USDT_DEGEN_REWARD_ADDR;
    const rewardTokenAddr = DEGEN_TOKEN_ADDR;
    const rewardTokenTicker = "DEGEN";
    const prices = await lookUpPrices(["tether", "spaghetti"]);
    const pairTokenPrice = prices["tether"].usd;
