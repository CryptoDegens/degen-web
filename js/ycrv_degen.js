...
async function main() {
    ...
    const stakingTokenAddr = DEGEN_YCRV_DEGEN_UNI_TOKEN_ADDR;
    const stakingTokenTicker = "UNIV2";
    const pairTokenAddr = YCRV_TOKEN_ADDR;
    const pairTokenTicker = "YCRV";
    const rewardPoolAddr = DEGEN_YCRV_DEGEN_REWARD_ADDR;
    ...
    const pairTokenPrice = await CURVE_Y_POOL.get_virtual_price() / 1e18;
