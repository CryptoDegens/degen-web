...
async function main() {
    ...
    const stakingTokenAddr = YYCRV_TOKEN_ADDR;
    const stakingTokenTicker = "YYCRV";
    const rewardPoolAddr = YYCRV_REWARD_ADDR;
    const rewardTokenAddr = DEGEN_TOKEN_ADDR;
    const rewardTokenTicker = "DEGEN";
    const stakingTokenPrice = await getYYCRVPrice(App)
